...
$sourcePath = "C:\Users\stewm\OneDrive\Documents2\Thoughts\Thoughts\posts"
$destinationPath = "C:\Data\websites\blog\content\posts"

# Set Github repo 
$myrepo = "git@github.com:virtuallyanadmi/blog.git"
